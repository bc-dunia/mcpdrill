...
const icons: Record<IconName, JSX.Element> = {
  ...
  loader: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="icon-spin">
  ...
  'plane-takeoff': (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M2 22h20" />
      <path d="M6.36 17.4 4 17l-2-4 1.1-.55a2 2 0 0 1 1.8 0l.17.1a2 2 0 0 0 1.8 0L8 12 5 6l3-1 4 5.5 6-3 1.5.5a2 2 0 0 1 1.3 1.8v.3L20 11l-5 3-4-3-4.36 6.4Z" />
    </svg>
  ),
  'trending-up': (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
function IconComponent({ name, size = 'md', className = '', 'aria-hidden': ariaHidden = true }: IconProps) {
